        ...
        <div class="col-12 col-sm-8 col-md-6">
            <form class="form mt-5" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3 text-dark">
                    ...
                    <input name="image" type="file" class="form-control text-dark">
                    @error('image')
                        <span class="fs-6 text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="submit" name="submit" class="btn btn-dark btn-md" value="sign up">
                </div>
                <div class="text-right mt-2">
                    <a href="{{route('login')}}" class="text-dark">if you have an account, log in here</a>
                </div>
            </form>
        </div>
    </div>
